        ...
        <View style={[styles.searchengineContainer]}>
              <View style={[styles.hflex]}> 
                    ...
                    <TextInput style={[styles.inputbox]}
                      placeholder="Search for Cardinal Doctors"
               ...
               <Text style={[styles.avai]}>Available Cardiologists</Text>           
                <View style={[styles.profilecard]}>
                 <View style={[styles.container1]}>
                    <View style={[styles.container2]}>
                    <Icon name="user-md" size={80} color="#4d5454" /> 
                        <View style={[styles.verflex]}>
                            <Text style={[styles.text]}>Dr.Sishir Poudel</Text>
                 ...
                 <View style={[styles.container1]}>
                    ...
                    <Icon name="user-md" size={80} color="#4d5454" /> 
                        <View style={[styles.verflex]}>
                            <Text style={[styles.text]}>Dr.Dipin Timilsina</Text>
